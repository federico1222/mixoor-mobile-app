...
// import { NetworkProviderContext } from "../provider/network-provider";
...
//   const { network } = useContext(NetworkProviderContext);
...
//       const legacyPubkey = new PublicKey(Buffer.from(base64Address, "base64"));
